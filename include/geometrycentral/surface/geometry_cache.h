...
public:
  ...
  surface::FaceData<Vector3> faceAreaNormals;

  // Face areas
  inline void requireFaceAreas() { faceAreasQ.require(); }
  surface::FaceData<double> faceAreas;
  ...
  surface::HalfedgeData<Complex> halfedgeFaceCoords;
  ...
  surface::HalfedgeData<Complex> faceTransportCoefs;

  // Halfedge opposite angles
  inline void requireHalfedgeOppositeAngles() { halfedgeOppositeAnglesQ.require(); }
  surface::HalfedgeData<double> halfedgeOppositeAngles;
  ...
  surface::HalfedgeData<double> halfedgeRescaledOppositeAngles;
  ...
  surface::HalfedgeData<Complex> halfedgeVertexCoords;
  ...
  surface::HalfedgeData<Complex> vertexTransportCoefs;
  ...
  surface::HalfedgeData<Complex> vertexFaceTransportCoefs;
